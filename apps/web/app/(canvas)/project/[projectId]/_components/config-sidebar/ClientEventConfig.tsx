      ...
      >
        <AccordionItem value="settings" className="border-none">
          <AccordionTrigger className="py-0 hover:no-underline">
            <h3 className="text-[10px] py-2 font-bold text-muted-foreground uppercase tracking-wider text-left">
              Event Settings
            </h3>
          </AccordionTrigger>
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    {eventType === "other" && (
                      <Input
                        ...
                        onBlur={() =>
                          handleUpdateEvent(eventName, customEvent, eventSchema)
                        }
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {endpoint && (
                      <Button
                        ...
                        onClick={inferSchemaFromEndpoint}
                      >
                        Fetch from Endpoint
                      </Button>
                    )}
