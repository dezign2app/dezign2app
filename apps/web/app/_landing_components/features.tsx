          ...
          <div className="flex-1 flex flex-col gap-2 w-full">
            {features.map((feature) => {
              ...
              return (
                ...
                >
                  <div
                    className={`text-xl mt-0.5 transition-transform duration-500 ${isActive ? "scale-110" : ""}`}
                  >
                    {feature.icon}
                  </div>
                  <div>
                    <h3
                      className={`text-base font-bold transition-colors duration-300 ${isActive ? "text-gray-900" : "text-gray-600 hover:text-gray-900"}`}
                    >
                      {feature.title}
                    </h3>
                    <div
...
export const EffortlessSection = () => {
  const [billing, setBilling] = React.useState<"monthly" | "annually">(
    "monthly",
  );
