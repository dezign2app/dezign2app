...
export const vectorDbRefDataSchema = baseNodeDataSchema
  .extend({
...
// --- Search Index Node ---
export const searchIndexDataSchema = baseNodeDataSchema
  .extend({
    description: z.string().optional(),
    // Core Resources
    searchSources: z
...
export type SearchSource = NonNullable<
  z.infer<typeof searchIndexDataSchema>["searchSources"]
>[number];
export type SearchIndexItem = SearchSource["indexes"][number];

// --- LLM Node ---
export const llmDataSchema = baseNodeDataSchema
  .extend({
    description: z.string().optional(),
...
// --- MCP Server Node ---
export const mcpServerDataSchema = baseNodeDataSchema
  .extend({
    description: z.string().optional(),
    // Core Resources (Basic)
    tools: z.array(resourceItemSchema).optional(),
