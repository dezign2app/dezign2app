...
import { FileJson, Settings2, MessageSquare, AlertTriangle } from "lucide-react";
...
interface AgentStructuredOutputSectionProps {
  ...
  updateResponseFormat: (changes: Partial<LangGraphAgentResponseFormatConfig>) => void;
}
              ...
              <div className="flex flex-col gap-1.5">
                ...
                >
                  ...
                  <SelectContent>
                    ...
                    <SelectItem value="custom_message">Custom Error Prompt</SelectItem>
