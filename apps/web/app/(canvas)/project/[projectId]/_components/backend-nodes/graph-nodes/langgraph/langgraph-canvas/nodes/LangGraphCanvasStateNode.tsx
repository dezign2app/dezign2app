    ...
    >
      ...
      <div className="flex flex-col gap-1.5 nodrag">
        ...
        {channels.slice(0, 5).map((ch, idx) => (
          <div
            key={ch.key || idx}
            className="flex items-center justify-between bg-secondary/40 px-2 py-1 rounded text-[10px] font-mono border border-border/40"
          >
            ...
            <div className="flex items-center gap-1">
              ...
              <span className="text-[9px] px-1 rounded bg-secondary text-[#006ddd] font-semibold">
                {ch.reducer}
              </span>
            </div>
          </div>
        ...
        {channels.length > 5 && (
          <span className="text-[9px] text-muted-foreground text-center font-mono">
            +{channels.length - 5} more fields
          </span>
        )}
      </div>
    </div>
