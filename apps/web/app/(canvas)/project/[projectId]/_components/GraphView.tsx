...
export function GraphView({ projectId }: GraphViewProps) {
  ...
  const clearSelectedTestCase = useSimulationStore(
    (state) => state.clearSelectedTestCase,
  );
      ...
      >
        ...
        >
          ...
          <Button
            ...
            onClick={() => handleAddGraphNode("webClient", "Client")}
          >
          ...
          <Button
            ...
            size="sm"
            className="bg-sidebar dark:bg-sidebar shadow-sm text-xs justify-start h-8 shrink-0"
            onClick={() => handleAddGraphNode("worker", "Worker")}
          >
          ...
          <Button
            ...
            size="sm"
            className="bg-sidebar dark:bg-sidebar shadow-sm text-xs justify-start h-8 shrink-0"
            onClick={() => handleAddGraphNode("redis-pubsub", "Redis Pub/Sub")}
          >
          ...
          <Button
            ...
            size="sm"
            className="bg-sidebar dark:bg-sidebar shadow-sm text-xs justify-start h-8 shrink-0"
            onClick={() => handleAddGraphNode("sqs", "Queue")}
          >
          ...
          <Button
            ...
            size="sm"
            className="bg-sidebar dark:bg-sidebar shadow-sm text-xs justify-start h-8 shrink-0"
            onClick={() => handleAddGraphNode("redis-cache", "Cache")}
          >
          ...
          <Button
            ...
            size="sm"
            className="bg-sidebar dark:bg-sidebar shadow-sm text-xs justify-start h-8 shrink-0"
            onClick={() => handleAddGraphNode("search_index", "Search Index")}
          >
          ...
          <Button
            ...
            size="sm"
            className="bg-sidebar dark:bg-sidebar shadow-sm text-xs justify-start h-8 shrink-0"
            onClick={() => handleAddGraphNode("api_gateway", "API Gateway")}
          >
          ...
          <Button
            ...
            className="bg-sidebar dark:bg-sidebar shadow-sm text-xs justify-start h-8 shrink-0"
            onClick={() =>
              handleAddGraphNode("identity_provider", "Identity Provider")
            }
          >
          ...
          <Button
            ...
            size="sm"
            className="bg-sidebar dark:bg-sidebar shadow-sm text-xs justify-start h-8 shrink-0"
            onClick={() => handleAddGraphNode("webhook", "Webhook")}
          >
          ...
          <Button
            ...
            size="sm"
            className="bg-sidebar dark:bg-sidebar shadow-sm text-xs justify-start h-8 shrink-0"
            onClick={() => handleAddGraphNode("llm", "LLM")}
          >
          ...
          <Button
            ...
            size="sm"
            className="bg-sidebar dark:bg-sidebar shadow-sm text-xs justify-start h-8 shrink-0"
            onClick={() => handleAddGraphNode("mcp_server", "MCP Server")}
          >
