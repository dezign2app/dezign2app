    ...
    >
      ...
      <div className="px-3 py-2 border-b nodrag flex flex-col gap-2">
        <div className="flex items-center gap-2">
          <Label className="text-[10px] text-muted-foreground uppercase font-bold tracking-wider shrink-0 w-24">
            Implementation
          </Label>
          <Select
        ...
        <div className="flex items-center gap-2">
          ...
          <Input
            ...
            value={data.model || ""}
            onChange={(e) =>
              updateNode(id, { data: { ...data, model: e.target.value } })
            }
          />
        </div>
      </div>
          ...
          <div className="flex flex-col gap-2.5 pt-2 border-t border-border/50 nodrag">
            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <Switch
                ...
                onCheckedChange={(val) =>
                  updateNode(id, { data: { ...data, toolCalling: val } })
                }
              />
            </div>
            <div className="flex items-center justify-between gap-2">
              <Label
                htmlFor={`structured-output-${id}`}
                className="text-xs text-muted-foreground"
              >
                Structured Output
              </Label>
              <Switch
                ...
                onCheckedChange={(val) =>
                  updateNode(id, { data: { ...data, structuredOutput: val } })
                }
              />
            </div>
          </div>
