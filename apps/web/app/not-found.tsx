      ...
      >
        ...
        <div className="mt-16 grid grid-cols-2 gap-8 text-sm text-muted-foreground border-t border-white/5 pt-8 w-full">
            <div className="space-y-2">
                <p className="font-semibold text-white/50 uppercase tracking-widest text-xs">Shortcuts</p>
            ...
            <div className="space-y-2 text-right">
                <p className="font-semibold text-white/50 uppercase tracking-widest text-xs">Support</p>
                <Link href="mailto:support@flowify.com" className="block hover:text-white transition-colors">Contact Us</Link>
