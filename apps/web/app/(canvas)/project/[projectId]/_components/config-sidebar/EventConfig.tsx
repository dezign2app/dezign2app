...
export const EventConfig = ({ id, nodeId }: EventConfigProps) => {
  ...
  type ConfigItemData = AnyMessagingResource & {
    variant?: string;
    nodeId?: string;
  };
          ...
          return (
            <div className="flex gap-4">
              <div className="flex-1 flex flex-col gap-2 rounded-xl border bg-card/50 p-4 shadow-sm">
                ...
                {edges.filter((e) => e.targetResourceId === item!.id).length ===
                0 ? (
                  ...
                  <div className="flex flex-col gap-1.5">
                    {edges
                      ...
                      .map((e, i) => {
                        ...
                        if (!eventId) {
                          if (
                            e.sourceHandle?.startsWith("publishedEvents-out-")
                          ) {
              ...
              <div className="flex-1 flex flex-col gap-2 rounded-xl border bg-card/50 p-4 shadow-sm">
                ...
                {edges.filter((e) => e.sourceResourceId === item!.id).length ===
                0 ? (
                  <span className="text-xs text-muted-foreground/60 italic">
                    {noSubText}
                  </span>
                  ...
                  <div className="flex flex-col gap-1.5">
                    {edges
                      ...
                      .map((e, i) => {
                        ...
                        if (!eventId) {
                          if (
                            e.targetHandle?.startsWith("consumedEvents-in-")
                          ) {
